		...
		<tbody>
			...
			<tr>
				<td colspan="3" style = 'border: none !important;'>
					<p style = 'margin-bottom:3px;'>Total days of school : </p>
					<p style = 'margin-bottom:3px;'>Total days present : </p>
				</td>
			...
			<tr>
				<td colspan="7" style = 'border: none !important;'>
					<p style = 'margin-bottom:3px;'>Has advance in: </p>
					<p style = 'margin-bottom:3px;'>Lacks units in: </p>
...
<p class ='pull-right' style="position:relative;right:100px !important;">VIVIAN V. DUDAS</p><br/>
