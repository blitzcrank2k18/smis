...
<a class="btn btn-sm btn-primary pull-left" style = "position:relative;left:10px;" href="smis.php?request=form_record&student_id=<?php echo $_GET['student_id'] ?>&form=record"><i class="fa fa-print"></i> Print Form 137</a>		
